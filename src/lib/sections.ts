...
export const SECTIONS: Section[] = [
	{
		...
		icon: 'adjustments',
		group: 'herramientas',
		card: 'JSON a YAML, cron en cristiano, regex, Base64, HTML a PHP, colores, gradientes, sombras, transiciones, animaciones SVG, parallax, maquetador, análisis de imagen, superposición de capturas, tramas, gráficos, barras, diagramas, ASCII art, tema y config.',
		intro:
